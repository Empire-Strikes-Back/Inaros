       ...
       [:> ThemeSongGuyMenu
        {:mode "horizontal"
         ...
         :items [{:type "item"
                 ...
                 {:type "item"
                  :label
                  (Kuzco.core/as-element [:a {:href (Yzma.frontend.easy/href :rc-brackets-page)} "brackets"])
...
(defn -main
  ...
  (go
    ...
    (router-process {})
    (ops-process {})
    (.render @(:dom-rootA root) (Kuzco.core/as-element [rc-current-page]))
